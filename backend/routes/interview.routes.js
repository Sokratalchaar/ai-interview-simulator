...
const { startInterview, getUserInterviews,getInterviewDetails,updateSessionStatus,deleteInterview,getSessionQuestions,answerQuestion,evaluateAnswer,getInterviewScore,generateNextQuestion,getDashboardStats,getAIInsights,translateInsights } = require("../controllers/interview.controller");
